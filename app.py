...
def upload_process():
    ...
    try:
        ...
        for _, row in df.iterrows():
            op_name, sp_name, client, created_at = row.get('Usuário'), row.get('Assunto'), str(row.get('Cliente', 'N/A')), pd.to_datetime(row.get('Criado em'))
...
def reports():
    ...
    return render_template('reports.html',
        ...
        attendances_by_operator=attendances_by_operator,
        attendances_by_subprocess=attendances_by_subprocess,
